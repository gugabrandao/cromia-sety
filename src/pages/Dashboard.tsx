    ...
    <div className="selection:bg-brand-purple/30 animate-fade-in">
      ...
      <div className="pr-8 py-8 max-w-7xl mx-auto">
        ...
        <header className="flex items-center justify-between mb-12">
          <div>
            <h1 className="text-4xl font-semibold tracking-tight text-foreground mb-4 flex items-center gap-2">
              Cromia
              <div
                className="h-12 w-32 mb-1 bg-gradient-to-r from-brand-accent to-purple-400"
                style={{
            ...
            <p className="text-foreground/50 -mt-4 tracking-wider text-xl">{t('tagline')}</p>
          </div>
          ...
          {recentSongs.map((song) => (
            ...
            >
              ...
              <button
                ...
                className="absolute bottom-4 right-4 z-20 p-2 rounded-lg bg-red-500/10 text-red-500 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-500 hover:text-white"
